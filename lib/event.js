...
var eventSource = {
  ...
  endDrag: function endDrag(props, monitor, component) {
    ...
    component.props.dispatch((0, _actions.moveEvent)(props, monitor.getDropResult(), component.state.offset));
  },
...
var Event = (function (_React$Component) {
  function Event(props) {
    ...
    this.stopDrag = function (ev) {
      ...
      dispatch((0, _actions.updateEventDuration)({ disabled: disabled, id: id, title: title, startDate: startDate, resource: resource, styles: styles }, newDuration));
  ...
  _createClass(_Event, [{
    ...
    value: function dispatchResize(props) {
      ...
      eventResized(props);
      dispatch((0, _actions.resetResizeDispatcher)({ disabled: disabled, id: id, title: title, startDate: startDate, resource: resource, duration: duration, styles: styles }));
    }
  }, {
    key: 'dispatchEventClick',
    value: function dispatchEventClick(props) {
    ...
    value: function render() {
      ...
      var boxStyleMerge = Object.assign({ width: width }, boxStyles);
      var resizerStyleMerge = Object.assign({ height: '100%' }, resizerStyles);
      var defaultStyles = { color: '#000', backgroundColor: 'darkgrey' };
      var eventStyleMerge = Object.assign({ width: width }, styles || defaultStyles, eventStyles);
