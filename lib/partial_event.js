...
var PartialEvent = (function (_React$Component) {
  ...
  _createClass(PartialEvent, [{
    ...
    value: function render() {
      ...
      var rest = _objectWithoutProperties(_props2, ['styles', 'isDragging', 'connectDragSource', 'connectDragPreview', 'id', 'title', 'children', 'rowHeight']);
      ...
      return _react2['default'].createElement(
        ...
        _react2['default'].createElement(
          'div',
          { className: 'event', style: eventStyleMerge },
          title
        )
      );
    }
