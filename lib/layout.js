...
var Layout = (function (_Component) {
  ...
  _createClass(Layout, [{
    ...
    value: function render() {
      ...
      var rangeDidChange = _props.rangeDidChange;
      var rangeChanged = _props.rangeChanged;
      ...
      return _react2['default'].createElement(
        ...
        _react2['default'].createElement(_range_selector2['default'], { range: range, rangeChanged: rangeChanged, rangeDidChange: rangeDidChange }),
        _react2['default'].createElement(
          ...
          _react2['default'].createElement(
            ...
            _react2['default'].createElement(_resources2['default'], { height: rowHeight, width: width, resources: resources }),
    ...
    value: {
      ...
      rangeChanged: _react.PropTypes.func.isRequired,
      rangeDidChange: _react.PropTypes.bool.isRequired,
...
exports['default'] = (0, _reactRedux.connect)(function (state) {
  ...
  var rangeDidChange = _state$range$toJS.rangeDidChange;
  ...
  var cells = _state$cells$toJS.cells;
